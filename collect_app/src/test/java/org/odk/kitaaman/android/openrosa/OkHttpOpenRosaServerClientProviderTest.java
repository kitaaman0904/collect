...
public class OkHttpOpenRosaServerClientProviderTest extends OpenRosaServerClientProviderTest {
    ...
    public void credentialsHaveChangedTest() {
        ...
        clientProvider.get("https", "Dalvik/2.1.0 (Linux; U; Android 9; Android SDK built for x86 Build/PSR1.180720.093) org.odk.kitaaman.android/v1.23.3-127-g2e2b1ac76", newCredentials);
