...
public class StoragePathProviderTest {
    ...
    public void setup() {
        ...
        doReturn("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files").when(storagePathProvider).getScopedStorageRootDirPath();
    ...
    public void getStorageRootDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getStorageRootDirPath(), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files"));
    }
    ...
    public void getFormsDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getDirPath(StorageSubdirectory.FORMS), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms"));
    }
    ...
    public void getInstancesDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getDirPath(StorageSubdirectory.INSTANCES), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/instances"));
    }
    ...
    public void getMetadataDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getDirPath(StorageSubdirectory.METADATA), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/metadata"));
    }
    ...
    public void getCacheDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getDirPath(StorageSubdirectory.CACHE), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/.cache"));
    }
    ...
    public void getLayersDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getDirPath(StorageSubdirectory.LAYERS), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/layers"));
    }
    ...
    public void getSettingsDirWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getDirPath(StorageSubdirectory.SETTINGS), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/settings"));
    }
    ...
    public void getODKDirPathsWithScopedStorageTest() {
        ...
        assertThat(storageSubdirectories, hasItemInArray("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms"));
        assertThat(storageSubdirectories, hasItemInArray("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/instances"));
        assertThat(storageSubdirectories, hasItemInArray("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/.cache"));
        assertThat(storageSubdirectories, hasItemInArray("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/metadata"));
        assertThat(storageSubdirectories, hasItemInArray("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/layers"));
    }
    ...
    public void getFormDbPathWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getFormDbPath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets.xml"), is("All widgets.xml"));

        assertThat(storagePathProvider.getFormDbPath("All widgets-media"), is("All widgets-media"));
        assertThat(storagePathProvider.getFormDbPath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media"), is("All widgets-media"));

        assertThat(storagePathProvider.getFormDbPath("All widgets-media/itemsets.csv"), is("All widgets-media/itemsets.csv"));
        assertThat(storagePathProvider.getFormDbPath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media/itemsets.csv"), is("All widgets-media/itemsets.csv"));
    }
    ...
    public void getInstanceDbPathWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getInstanceDbPath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/instances/All widgets_2020-01-20_13-54-11/All widgets_2020-01-20_13-54-11.xml"), is("All widgets_2020-01-20_13-54-11/All widgets_2020-01-20_13-54-11.xml"));
    }
    ...
    public void getCacheDbPathWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getCacheDbPath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/.cache/a688a8b48b2e50c070bc76239f572e16.formdef"), is("a688a8b48b2e50c070bc76239f572e16.formdef"));
    }
    ...
    public void getAbsoluteFormFilePathWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getAbsoluteFormFilePath("All widgets.xml"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets.xml"));
        assertThat(storagePathProvider.getAbsoluteFormFilePath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets.xml"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets.xml"));

        assertThat(storagePathProvider.getAbsoluteFormFilePath("All widgets-media"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media"));
        assertThat(storagePathProvider.getAbsoluteFormFilePath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media"));

        assertThat(storagePathProvider.getAbsoluteFormFilePath("All widgets-media/itemsets.csv"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media/itemsets.csv"));
        assertThat(storagePathProvider.getAbsoluteFormFilePath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media/itemsets.csv"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/forms/All widgets-media/itemsets.csv"));
    }
    ...
    public void getAbsoluteInstanceFilePathWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getAbsoluteInstanceFilePath("All widgets_2020-01-20_13-54-11/All widgets_2020-01-20_13-54-11.xml"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/instances/All widgets_2020-01-20_13-54-11/All widgets_2020-01-20_13-54-11.xml"));
        assertThat(storagePathProvider.getAbsoluteInstanceFilePath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/instances/All widgets_2020-01-20_13-54-11/All widgets_2020-01-20_13-54-11.xml"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/instances/All widgets_2020-01-20_13-54-11/All widgets_2020-01-20_13-54-11.xml"));
    }
    ...
    public void getAbsoluteCacheFilePathWithScopedStorageTest() {
        ...
        assertThat(storagePathProvider.getAbsoluteCacheFilePath("a688a8b48b2e50c070bc76239f572e16.formdef"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/.cache/a688a8b48b2e50c070bc76239f572e16.formdef"));
        assertThat(storagePathProvider.getAbsoluteCacheFilePath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/.cache/a688a8b48b2e50c070bc76239f572e16.formdef"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/.cache/a688a8b48b2e50c070bc76239f572e16.formdef"));
    }
    ...
    public void getRelativeMapLayerPathTest() {
        ...
        assertThat(storagePathProvider.getRelativeMapLayerPath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/layers/countries/countries-raster.mbtiles"), is("countries/countries-raster.mbtiles"));
    }
    ...
    public void getOfflineMapLayerPathTestWithScopedStorage() {
        ...
        assertThat(storagePathProvider.getAbsoluteOfflineMapLayerPath(null), is(nullValue()));
        assertThat(storagePathProvider.getAbsoluteOfflineMapLayerPath("/sdcard/odk/layers/countries/countries-raster.mbtiles"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/layers/countries/countries-raster.mbtiles"));
        assertThat(storagePathProvider.getAbsoluteOfflineMapLayerPath("/storage/emulated/0/odk/layers/countries/countries-raster.mbtiles"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/layers/countries/countries-raster.mbtiles"));
        assertThat(storagePathProvider.getAbsoluteOfflineMapLayerPath("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/layers/countries/countries-raster.mbtiles"), is("/storage/emulated/0/Android/data/org.odk.kitaaman.android/files/layers/countries/countries-raster.mbtiles"));
