...
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.BEGINNING_OF_FORM;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.CONSTRAINT_ERROR;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.DELETE_REPEAT;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.END_OF_FORM;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.FINALIZE_ERROR;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.FORM_EXIT;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.FORM_FINALIZE;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.FORM_RESUME;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.FORM_SAVE;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.FORM_START;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.GOOGLE_PLAY_SERVICES_NOT_AVAILABLE;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.GROUP;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.HIERARCHY;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_GRANTED;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PERMISSIONS_NOT_GRANTED;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PROVIDERS_DISABLED;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_TRACKING_DISABLED;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.LOCATION_TRACKING_ENABLED;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.PROMPT_NEW_REPEAT;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.QUESTION;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.REPEAT;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.SAVE_ERROR;
import static org.odk.kitaaman.android.formentry.audit.AuditEvent.AuditEventType.UNKNOWN_EVENT_TYPE;
import static org.odk.kitaaman.android.formentry.audit.AuditEventCSVLine.toCSVLine;
